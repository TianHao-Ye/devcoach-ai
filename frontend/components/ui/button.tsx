    ...
    variants: {
      variant: {
        default:
          ...
          "hover:-translate-y-0.5 hover:bg-primary/90 hover:shadow-[0_14px_30px_-12px_var(--primary)] " +
          "active:translate-y-0 active:shadow-sm",
        outline:
          "border-black/10 bg-white/70 shadow-sm hover:-translate-y-0.5 hover:border-primary/20 hover:bg-white hover:text-primary hover:shadow-md aria-expanded:bg-muted",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-[color-mix(in_oklch,var(--secondary),var(--foreground)_5%)] aria-expanded:bg-secondary aria-expanded:text-secondary-foreground",
        ghost: "text-muted-foreground hover:bg-white/80 hover:text-foreground aria-expanded:bg-muted",
        destructive:
